...
//				election.printCandidates((c) -> c.getId() + " " + c.getName() + ((c.isActive()) ? "" : "+"));
//				 System.out.println(election.countBallots((b) -> b.getRankByCandidate(1) == 2)); /* Returns count
//				of how many ballot have candidate 1 as rank 2 */
//				 System.out.println(election.countBallots((b) -> b.getRankByCandidate(2) == 2));/* Returns count
//				of how many ballot have candidate 2 as rank 2 */
//				 System.out.println(election.countBallots((b) -> b.eliminate(3))); /* Returns count of how many
